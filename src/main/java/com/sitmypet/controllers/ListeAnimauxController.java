...
public class ListeAnimauxController {
    ...
    private HBox buildPetCard(Pet pet) {
        ...
        // ---- Boutons Actions ----
        Button btnEdit = new Button("Modifier Modifier");
        ...
        Button btnDelete = new Button("Supprimer Supprimer");
    ...
    private void handleAjouter() {
        naviguer("/com/sitmypet/fxml/AjouterAnimal.fxml", "Ajouter un animal");
    }

    private void handleModifier(Pet pet) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/sitmypet/fxml/ModifierAnimal.fxml"));
