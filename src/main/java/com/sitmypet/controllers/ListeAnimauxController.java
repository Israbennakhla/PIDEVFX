...
public class ListeAnimauxController {
    ...
    private void handleAjouter() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/sitmypet/fxml/AjouterAnimal.fxml"));
            Parent root = loader.load();
            Stage dlg = new Stage();
            dlg.initOwner(listAnimaux.getScene().getWindow());
            dlg.initModality(Modality.WINDOW_MODAL);
            dlg.setTitle("Ajouter un animal");
            dlg.setScene(new Scene(root, 820, 720));
