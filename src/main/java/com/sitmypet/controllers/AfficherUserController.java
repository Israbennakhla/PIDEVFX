...
public class AfficherUserController {
    ...
    /** Utilisé par {@link DashboardController} pour ouvrir directement un écran gestion ({@code users}, {@code animaux}, {@code annonces}, {@code postulations}). */
    ...
    private void markSidebarActive(Button active) {
        for (Button b : new Button[] { btnNavUsers, btnNavAnimaux, btnNavAnnonces, btnNavPostulations }) {
