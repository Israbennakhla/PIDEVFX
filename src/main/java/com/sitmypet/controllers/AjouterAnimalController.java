...
public class AjouterAnimalController {
    ...
    private void handleEnregistrer() {
        ...
        // savedImageName = URL Cloudinary (ex: "https://res.cloudinary.com/...")
        ...
        try {
            ...
            alert(Alert.AlertType.INFORMATION, "Succes", "Animal \"" + nom + "\" enregistre !");
            handleRetour();
        } catch (Exception e) { alert(Alert.AlertType.ERROR, "Erreur", "Erreur : " + e.getMessage()); }
    }

    @FXML private void handleRetour()          { nav("/com/sitmypet/fxml/AfficherAnimales.fxml",    "Mes Animaux"); }
    ...
    private void nav(String fxml, String titre) {
        try {
            ...
            stage.setScene(new Scene(FXMLLoader.load(res))); stage.setTitle(titre); stage.show();
