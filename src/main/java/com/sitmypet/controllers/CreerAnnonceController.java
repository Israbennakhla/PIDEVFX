...
public class CreerAnnonceController {
    ...
    @FXML private void handleNavEvenements()    { naviguer("/com/sitmypet/fxml/AfficherEvenements.fxml",  "Evenements"); }
    @FXML private void handleNavAnimaux()       { naviguer("/com/sitmypet/fxml/AfficherAnimales.fxml",    "Mes Animaux"); }
    @FXML private void handleNavReclamations()  { naviguer("/com/sitmypet/fxml/AfficherReclamations.fxml","Reclamations"); }
