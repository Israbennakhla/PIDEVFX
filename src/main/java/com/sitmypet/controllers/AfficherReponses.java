...
public class AfficherReponses implements Initializable {
    ...
    private VBox creerCarteReponse(Reponse rep) {
        ...
        Button btnModifier = new Button("Modifier Modifier");
        ...
        Button btnSupprimer = new Button("Supprimer Supprimer");
    ...
    private void ouvrirModificationReponse(Reponse rep) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/sitmypet/fxml/ModifierReponse.fxml"));
            Parent root = loader.load();
