...
public class AfficherReclamations implements Initializable {
    ...
    private VBox creerCarte(Reclamation r) {
        ...
        Button btnMod = new Button("Modifier Modifier");
        btnMod.setMinWidth(90);
        btnMod.getStyleClass().add("btn-modifier");

        Button btnSup = new Button("Supprimer Supprimer");
        btnSup.setMinWidth(110);
        btnSup.getStyleClass().add("btn-supprimer");

        Button btnRep = new Button("Repondre Réponses");
    ...
    private void ouvrirAjout() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/sitmypet/fxml/AjouterReclamation.fxml"));
    ...
    private void ouvrirModification(Reclamation r) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/sitmypet/fxml/ModifierReclamation.fxml"));
    ...
    private void voirReponses(Reclamation r) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/sitmypet/fxml/AfficherReponses.fxml"));
            Parent root = loader.load();
